    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-[250px] right-6 z-50 flex items-center gap-2 group"
          aria-label="Ouvrir le chat"
        >
          <span className="bg-primary-600 text-white text-sm font-medium px-3 py-1.5 rounded-full shadow-lg opacity-90 group-hover:opacity-100 transition-opacity">
            Questions ?
          </span>
          <span className="w-14 h-14 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all group-hover:scale-105">
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="fixed bottom-[250px] right-6 z-50 w-[calc(100%-3rem)] sm:w-96 max-h-[70vh] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          {/* Header */}
