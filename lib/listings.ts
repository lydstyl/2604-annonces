...
export const listings: Record<string, Listing> = {
  'raismes-t3': {
    id: 'raismes-t3',
    title: 'Spacieux T3 de 85 m² – Raismes Centre – Disponible fin septembre',
    ...
    availableFrom: '25 septembre 2025',
    faq: [
      {
        question: 'Quand puis-je visiter le logement ?',
        answer: 'Les visites sont organisées sur rendez-vous. Après avoir soumis votre candidature, nous vous contacterons pour organiser une visite si votre profil correspond aux critères.',
      },
      {
        question: 'Quels documents dois-je fournir pour le dossier ?',
        answer: 'Vous devrez fournir : pièce d\'identité, 3 derniers bulletins de salaire, contrat de travail, avis d\'imposition, justificatif de domicile actuel, et RIB.',
      },
      {
        question: 'Les animaux sont-ils acceptés ?',
        answer: 'Les animaux de compagnie ne sont pas acceptés dans ce logement.',
      },
      {
        question: 'Y a-t-il un parking ?',
        answer: 'Le stationnement est facile et gratuit dans la rue à proximité immédiate de l\'appartement.',
      },
      {
        question: 'Les charges incluent quoi ?',
        answer: 'Les charges de 35€/mois couvrent l\'entretien des parties communes et l\'eau. L\'électricité et le gaz sont à la charge du locataire.',
      },
    ],
  },
};
